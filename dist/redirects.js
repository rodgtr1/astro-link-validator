 ...
 */
export function parseRedirects(content) {
    const rules = [];
 ...
 */
export async function loadRedirects(buildDir, redirectsFile) {
    if (!redirectsFile) {
 ...
 */
export function findRedirectRule(path, rules) {
 ...
 */
export function applyRedirectRule(path, rule) {
